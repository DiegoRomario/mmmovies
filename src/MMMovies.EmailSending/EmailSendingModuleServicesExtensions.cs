...
using MMMovies.EmailSending.Data;
...
namespace MMMovies.EmailSending;

public static class EmailSendingModuleServicesExtensions
{
    public static IServiceCollection AddEmailSendingModuleServices(this IServiceCollection services, ConfigurationManager config, ILogger logger, List<Assembly> mediatRAssemblies)
    {
        // configure MongoDB
      ...
      IConfiguration configuration)
    {
        ...
        services.AddTransient(serviceProvider =>
        {
            ...
            return database!.GetCollection<EmailOutbox>("EmailOutboxEntityCollection");
        });
