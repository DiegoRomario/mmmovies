...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMMovies.OrderProcessing.Domain.Order", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BillingAddress", "MMMovies.OrderProcessing.Domain.Order.BillingAddress#Address", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ShippingAddress", "MMMovies.OrderProcessing.Domain.Order.ShippingAddress#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("MMMovies.OrderProcessing.Domain.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MMMovies.OrderProcessing.Domain.OrderItem", b =>
                {
                    b.HasOne("MMMovies.OrderProcessing.Domain.Order", null)
                        .WithMany("OrderItems")
